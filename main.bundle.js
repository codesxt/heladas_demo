...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FrostService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var FrostService = (function () {
    function FrostService(http) {
        this.http = http;
        this.baseURL = __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].apiUrl;
    }
    FrostService.prototype.getDayBeforePrediction = function (stationId) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({});
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({
            headers: headers
        });
        return this.http.post(this.baseURL + '/consulta/index_dia_anterior.php?id_est=' + stationId, { id_est: stationId }, options).map(function (response) { return response.json(); });
    };
    FrostService.prototype.getDayPrediction = function (stationId) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({});
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({
            headers: headers
        });
    ...
    FrostService.prototype.getStations = function () {
        ...
        return this.http.post(this.baseURL + '/monitor/acciones.php?acc=2', { acc: 2 }, options).map(function (response) { return response.json(); });
    };
    FrostService = __decorate([
...
//# sourceMappingURL=frost.service.js.map
